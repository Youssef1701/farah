...
(function (m) {
  m.fn.textfill = function (r) {
    ...
    this.each(function () {
      ...
      f(
        "[TextFill] Maximum sizes: { Height: " + b + "px, Width: " + e + "px }"
      );
      ...
      a.widthOnly
        ? (c.css({ "font-size": l, "white-space": "nowrap" }),
          a.changeLineHeight && c.parent().css("line-height", n * l + "px"))
        : ((g = Math.min(h, l)),
          c.css("font-size", g),
      ...
      c.width() > e || (c.height() > b && !a.widthOnly)
        ? (c.css("font-size", k),
          a.fail && a.fail(this),
          f(
        ...
        ? a.success(this)
        : a.callback &&
          (s("callback is deprecated, use success, instead"), a.callback(this));
    });
